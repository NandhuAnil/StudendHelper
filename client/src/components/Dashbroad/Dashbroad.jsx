    ...
    <div>
        ...
        {images.map((image) => (
            <Carousel.Item key={image._id} >
                <div style={{ display: 'flex' , justifyContent: 'center'}}><img style={{ height: '95vh', objectFit: 'cover', margin: '0 auto', width: '80vw' }} className="d-flex" src={`http://localhost:3001/${image.imagePath}`} alt="Bannar"/></div>
                <div>
